...
_CAPABILITY_REGISTRY: dict[str, dict] = {
    ...
    "memory_lookup": {
        ...
        "description": "Readonly keyword lookup in memory_index — no inference",
        "input_requirements": ["query keywords match a memory_index entry"],
        "execution_class": "deterministic",
        "locality": "local",
        "mutating": False,
        "availability": "available",
        "reason_for_selection": "memory keyword match found",
    },
    "brody_readonly": {
        "capability_id": "brody_readonly",
        "description": "Brody readonly adapter — HTTP loopback, no write, no world action",
        "input_requirements": ["BRODY_ENDPOINT set, loopback, health check passes"],
        "execution_class": "model_local",
        "locality": "local",
        "mutating": False,
        "availability": "conditional",
        "reason_for_selection": "brody readonly endpoint available and responded",
    },
    "local_qwen": {
